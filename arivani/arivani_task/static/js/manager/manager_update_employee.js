...
function set_user_is_active(user_pk){
  ...
  fetch(
    manager_app_set_employee_is_active_url,{
      method:'POST',
      credentials:'same-origin',
      headers:{
        'X-Requested-With':'XMLHttpRequest',
...
function send_data(data){
  fetch(
    manager_app_update_employee_record_url,{
      method:'POST',
      credentials:'same-origin',
      headers:{
        'X-Requested-With':'XMLHttpRequest',
...
function delete_user(user_pk){
  ...
  fetch(
    manager_app_soft_delete_employee_url,{
      method:'POST',
      credentials:'same-origin',
      headers:{
        'X-Requested-With':'XMLHttpRequest',
...
function get_all_deleted_ursers_by_hr(){
  fetch(
    manager_app_gel_all_deleted_employee_url,{
      method:'POST',
      credentials:'same-origin',
      headers:{
        'X-Requested-With':'XMLHttpRequest',
...
function restore_user(user_id){
  ...
  fetch(
    manager_app_restore_employee_url,{
      method:'POST',
      credentials:'same-origin',
      headers:{
        'X-Requested-With':'XMLHttpRequest',
...
function delete_user_permanently(user_id){
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.isConfirmed) {
        ...
        fetch(
            manager_app_delete_employee_permanently_url,{
            method:'POST',
            credentials:'same-origin',
            headers:{
              'X-Requested-With':'XMLHttpRequest',
...
function get_deleted_users_count(){
  fetch(
    manager_app_get_all_deleted_employee_count_url,{
      method:'POST',
      credentials:'same-origin',
      headers:{
        'X-Requested-With':'XMLHttpRequest',
